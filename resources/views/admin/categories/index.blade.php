            ...
            <table class="table table-striped table-inverse table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button form="category-{{$category->id}}" type="submit" class="btn btn-primary mb-1 text-white">
                            ...
                            <button type="button" class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#delete-category-{{$category->id}}">
